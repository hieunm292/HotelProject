<%-- 
    Document   : BookForm
    Created on : Jul 19, 2020, 5:00:54 PM
    Author     : ADMIN
--%>
...
<html class="supernova"><head>
        ...
        <!--        <link rel="alternate" type="application/json+oembed" href="https://www.jotform.com/oembed/?format=json&amp;url=https%3A%2F%2Fform.jotform.com%2F202002309193442" title="oEmbed Form">-->
        <!--        <link rel="alternate" type="text/xml+oembed" href="https://www.jotform.com/oembed/?format=xml&amp;url=https%3A%2F%2Fform.jotform.com%2F202002309193442" title="oEmbed Form">-->
        <meta property="og:title" content="Hotel Booking Form" >
        <!--        <meta property="og:url" content="https://form.jotform.com/202002309193442" >-->
        <meta property="og:description" content="Please click the link to complete this form.">
        <meta name="slack-app-id" content="AHNMASS8M">
        <!--        <link rel="canonical" href="https://form.jotform.com/202002309193442" />-->
    ...
    <body>
        <form class="jotform-form" action="https://submit.jotform.com/submit/202002309193442/" method="post" name="form_202002309193442" id="202002309193442" accept-charset="utf-8" autocomplete="on">
            <input type="hidden" name="formID" value="202002309193442" />
            ...
            <div role="main" class="form-all">
                <ul class="form-section page-section">
                    ...
                    <li class="form-line" data-type="control_dropdown" id="id_6">
                        <label class="form-label form-label-left form-label-auto" id="label_6" for="input_6"> Room Type </label>
                        <div id="cid_6" class="form-input">
                            <select class="form-dropdown" id="input_6" name="q6_roomType" style="width:180px" data-component="dropdown" aria-labelledby="label_6">
                                <option value="">  </option>
                    ...
                    <li class="form-line jf-required" data-type="control_spinner" id="id_18">
                        ...
                        <div id="cid_18" class="form-input jf-required">
                            <div data-wrapper-react="true">
                                <input type="number" id="input_18" name="q18_numberOf18" data-type="input-spinner" class="form-spinner-input  form-textbox validate[required]" value="0" data-component="spinner" aria-labelledby="label_18" required="" />
                            </div>
                        </div>
                    </li>
                    <li class="form-line jf-required allowTime" data-type="control_datetime" id="id_22">
                        <label class="form-label form-label-left" id="label_22" for="lite_mode_22">
                            Arrival Date &amp; Time
                            <span class="form-required">
                                *
                            </span>
                            ...
                            <div data-wrapper-react="true" class="extended">
                                <div style="display:none">
                                    <span class="form-sub-label-container " style="vertical-align:top">
                                        <input type="tel" class="form-textbox validate[required, limitDate]" id="month_22" name="q22_arrivalDate[month]" size="2" data-maxlength="2" maxLength="2" value="04" required="" autoComplete="off" aria-labelledby="label_22 sublabel_22_month" />
                                    ...
                                    <span class="form-sub-label-container " style="vertical-align:top">
                                        <input type="tel" class="form-textbox validate[required, limitDate]" id="day_22" name="q22_arrivalDate[day]" size="2" data-maxlength="2" maxLength="2" value="17" required="" autoComplete="off" aria-labelledby="label_22 sublabel_22_day" />
                                        <span class="date-separate" aria-hidden="true">
                                            -
                                        </span>
                                    ...
                                    <span class="form-sub-label-container " style="vertical-align:top">
                                        <input type="tel" class="form-textbox validate[required, limitDate]" id="year_22" name="q22_arrivalDate[year]" size="4" data-maxlength="4" data-age="" maxLength="4" value="2020" required="" autoComplete="off" aria-labelledby="label_22 sublabel_22_year" />
                                        <label class="form-sub-label" for="year_22" id="sublabel_22_year" style="min-height:13px" aria-hidden="false"> Year </label>
                                    </span>
                                </div>
                                <span class="form-sub-label-container " style="vertical-align:top">
                                    <input type="text" class="form-textbox validate[required, limitDate, validateLiteDate]" id="lite_mode_22" size="12" data-maxlength="12" maxLength="12" data-age="" value="04-17-2020" required="" data-format="mmddyyyy" data-seperator="-" placeholder="mm-dd-yyyy" autoComplete="off" aria-labelledby="label_22 sublabel_22_litemode" />
                                    <img class=" newDefaultTheme-dateIcon icon-liteMode" alt="Pick a Date" id="input_22_pick" src="https://cdn.jotfor.ms/images/calendar.png" data-component="datetime" aria-hidden="true" data-allow-time="Yes" data-version="v1" />
                                ...
                                <span class="allowTime-container">
                                    <span class="form-sub-label-container " style="vertical-align:top">
                                        <select class="currentTime time-dropdown form-dropdown validate[required, limitDate]" id="hour_22" name="q22_arrivalDate[hour]" aria-labelledby="label_22 sublabel_22_hour">
                                            <option>  </option>
                                    ...
                                    <span class="form-sub-label-container " style="vertical-align:top">
                                        <select class="time-dropdown form-dropdown validate[required, limitDate]" id="min_22" name="q22_arrivalDate[min]" aria-labelledby="label_22 sublabel_22_minutes">
                                            <option>  </option>
                    ...
                    <li class="form-line jf-required" data-type="control_birthdate" id="id_20">
                        ...
                        <div id="cid_20" class="form-input jf-required">
                            <div data-wrapper-react="true">
                                <span class="form-sub-label-container " style="vertical-align:top">
                                    <select name="q20_departureDate20[month]" id="input_20_month" class="form-dropdown validate[required]" data-component="birthdate-month" aria-labelledby="label_20 sublabel_20_month">
                                        <option>  </option>
                                    ...
                                    <label class="form-sub-label" for="input_20_month" id="sublabel_20_month" style="min-height:13px" aria-hidden="false"> Month </label>
                                </span>
                                <span class="form-sub-label-container " style="vertical-align:top">
                                    <select name="q20_departureDate20[day]" id="input_20_day" class="form-dropdown validate[required]" data-component="birthdate-day" aria-labelledby="label_20 sublabel_20_day">
                                        <option>  </option>
                                        <option value="1"> 1 </option>
                                        <option value="2"> 2 </option>
                                        <option value="3"> 3 </option>
                                    ...
                                    <label class="form-sub-label" for="input_20_day" id="sublabel_20_day" style="min-height:13px" aria-hidden="false"> Day </label>
                                </span>
                                <span class="form-sub-label-container " style="vertical-align:top">
                                    <select name="q20_departureDate20[year]" id="input_20_year" class="form-dropdown validate[required]" data-component="birthdate-year" aria-labelledby="label_20 sublabel_20_year">
                                        <option>  </option>
                                    ...
                                    <label class="form-sub-label" for="input_20_year" id="sublabel_20_year" style="min-height:13px" aria-hidden="false"> Year </label>
                                </span>
                            </div>
                        </div>
                    </li>
            ...
            <input type="hidden" id="simple_spc" name="simple_spc" value="202002309193442" />
            <script type="text/javascript">
                document.getElementById("si" + "mple" + "_spc").value = "202002309193442-202002309193442";
            </script>
